...
function Banner() {
  ...
  const clientReviews = [
    ...
    },
    {
      ...
      name: 'James Smith',
      profileImage: 'final1.jpg',
      message: 'This bot is a game-changer! Its like having a seasoned trader by your side 24/7, Impressive results and seamless performance.',
    },
    {
      id: 33,
      name: 'Emily Johnson',
      profileImage: 'final1.jpg',
      message: 'Stop second-guessing your trades; let this bot do the heavy lifting. Its consistently reliable and has boosted my profits significantly',
    },
    {
      id: 33,
      name: 'William Williams',
      profileImage: 'final1.jpg',
      message: 'Trading just got a whole lot easier with this bot. Its like having a personal assistant who always knows the right moves to make.',
    },
    {
      id: 33,
      name: 'Olivia Brown',
      profileImage: 'final1.jpg',
      message: 'Say goodbye to trading stress! This bot is a rock-solid performer, consistently delivering excellent results.',
    },
    {
      id: 33,
      name: 'Benjamin Jones',
      profileImage: 'final1.jpg',
      message: 'Ive tried many trading tools, but this bot stands out above the rest. Its dependable, efficient, and has greatly improved my trading success.',
    },
    {
      id: 33,
      name: 'Sophia Davis',
      profileImage: 'final1.jpg',
      message: 'If you are serious about trading, you need this bot in your arsenal. Its the secret sauce to staying profitable in any market.',
    },
    {
      id: 33,
      name: 'Michael Miller',
      profileImage: 'final1.jpg',
      message: 'Forget about guesswork; this bot takes the uncertainty out of trading. Its a must have for anyone serious about financial success.',
    },
  ];
